...
| [FEniCS (legacy)](https://fenicsproject.org/) | preCICE Developers | [code](https://github.com/precice/fenics-adapter), [docs](adapter-fenics.html) | Structure part in CHT, FSI, any FEM | |
...
| [BioDynaMo](https://biodynamo.org/) | Alexandros Iosif, University of Cyprus | | Agent-based model part in CFD–ABM coupling | Coupling of BioDynaMo with continuum solvers via preCICE; demonstrated with OpenFOAM |
